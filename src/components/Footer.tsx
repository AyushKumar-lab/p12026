          ...
          <div className="col-span-2 md:col-span-3 lg:col-span-2">
            ...
            >
              ...
              <span className="text-xl font-bold text-white">
                Loc<span className="text-primary-400">Intel</span>
              </span>
            </motion.div>
            <p className="text-slate-400 mb-6 max-w-sm">
              Transforming gut-feeling location decisions into data-driven business strategies. 
              Find your perfect commercial space with AI-powered intelligence.
            </p>
